...
export default function Index({
   ...
   * @returns 修改个人资料的方法
   */
  handleEditPersonInfo: () => void;
}) {
  return (
    <div
      className="card-info-person"
      style={{
        "--hover-color": sex === 1 ? "#0aa6ec" : "#f55d56",
        "--person-info-color": sex === 1 ? "#35b4ed" : "#fbb9b6",
      }}
    >
      <button className="card-info-mail">
        <svg
      ...
      <div className="profile-pic">
        {sex === 1 ? (
          <img src="https://img0.baidu.com/it/u=2683595353,2104394961&fm=253&fmt=auto&app=120&f=JPEG?w=800&h=800" />
        ) : (
          <Avatar />
        )}
      </div>
      <div className="bottom">
        <div className="card-info-content">
          <span className="name">
            尊敬的{`${currentUser}${sex === 1 ? "先生" : "女士"}`}：
          </span>
          <span className="about-me">
            欢迎来到创世纪系统，你将会得到一种全新的体验！
          </span>
        </div>
        <div className="bottom-bottom">
          ...
          <button className="editInfo-button" onClick={handleEditPersonInfo}>
            修改个人信息
          </button>
        </div>
      </div>
